...
const GtpSearchBar = () => {
  ...
  return (
    <div className='pt-[35%]  md:pt-[7%] flex justify-center'>
      <form className='md:m-0 m-2 p-2 w-full md:w-1/2 bg-slate-800 grid grid-cols-12'
      ...
      >
        ...
        <button className='p-2  m-2 md:m-4 bg-red-600 col-span-3 text-white rounded-lg'
